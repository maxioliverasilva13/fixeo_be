...
class ServicioSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Servicio
        fields = ['id', 'usuario', 'profesion', 'profesion_detalle', 'nombre', 'precio', 'divisa', 'tiempo', 'notas', 'foto', 'created_at', 'updated_at']
...
class ServicioCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = Servicio
        fields = ['profesion', 'nombre', 'precio', 'divisa', 'tiempo', 'notas', 'foto']
